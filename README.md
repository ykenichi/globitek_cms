...
<img src='http://i.imgur.com/WIHHfuv.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
I obtained a warning message **php - Warning: mysqli_query(): Couldn't fetch mysqli** after submitting the SQL data to the table and closing the database connection. This was resolved by calling unset($db); right after I close the database connection.
